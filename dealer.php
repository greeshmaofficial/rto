                ...
                <ul class="nav navbar-nav">
					...
					<li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                             ...
                             <li><i class="menu-icon fa fa-sign-in"></i><a href="dealer.php">Dealers</a></li>
							<li><i class="menu-icon fa fa-sign-in"></i><a href="manufact.php">Manufacture Details</a></li>
							<li><i class="menu-icon fa fa-sign-in"></i><a href="vehicle.php">Vehicle Details</a></li>
                        </ul>
                    </li>
...
<table  align="center" border="2px" style="width:800px; line-height:30px;"  >
			<tr >
				<th colspan="6" class="code"><h2 align="center">Dealer Details</h2></th>
		</tr>
			<tr align="center">
				<th style="text-align:center" >Dealer Name</th>
					<th style="text-align:center" >Vechile Maker</th>
			...
			while($rows=mysqli_fetch_array($result))
			{
	         ...
	         <tr align="center">
					...
					<td><?php echo $rows['vmaker']; ?> </td>
					<td><?php echo $rows['address']; ?> </td>
					
					
						<form action="dealer.php" method="post">
						<td><button class="button"><a href="add_dealer.php">ADD</a></button>&nbsp
						<button class="button" onclick="myfunction()"><a href="dealer.php">DELETE</a></button>&nbsp
					
						<button class="button"><a href="add_dealer.php">EDIT</a></button>&nbsp
						<!--<button class="button"><a href="update_dept.php">UPDATE</a></td></button>-->
