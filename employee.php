...
if(isset($_POST['submit']))
{
	...
	$photo=$_POST['photo'];
$sql="insert into employee(fname,gender,address,phone,email,dob,des,salary,qualify,photo)values('$fullname','$gender','$address','$phone','$email','$dob','$des','$salary','$qualify','$photo')";
...
<div class="row">
	...
	<div class="row">
      ...
      <div class="col-75">
        <input type="date" id="lname" name="dob" placeholder="Your designation..">
      </div>
    </div>
	  <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="text" id="lname" name="des" placeholder="Your designation..">
      </div>
    </div>
	<div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="text" id="lname" name="salary" placeholder="Your salary..">
      </div>
    </div>
	<div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="text" id="lname" name="qualify" placeholder="Your Qualification..">
      </div>
    </div>
	<div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
      <input type="file" id="lname" name="photo" placeholder="Required" >
      </div>
    </div>
