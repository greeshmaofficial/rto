...
$sql="insert into dealer(dname,vmaker,address)values('$dname','$vmaker','$address')";
    ...
    <div id="right-panel" class="right-panel">
       ...
       <div class="breadcrumbs">
		...
		<table align="center" border="1px" style="width:800px; line-height:30px;" >
			<tr >
				<th colspan="4"><h2 style="text-align:center" align="center">Add Dealer</h2></th>
		</tr>
 <tr><td align="center"><FORM action="add_dealer.php" method="post">
    
    Dealer Name: <INPUT type="text" name="dname"><br><br><br>
	Vechile Maker:<INPUT type="text" name="vmaker"><br><br><br>
	Address:<textarea name="address" cols="20" rows="2"></textarea><br><br>
    <INPUT type="submit" value="ADD" name="submit">&nbsp&nbsp&nbsp
