...
<body>
    ...
    <!-- Left Panel -->
<table  align="center" border="2px" style="width:100%; line-height:30px;"  >
	
			<tr >
				<td colspan="10" class="code"><h2 align="center">Employee Details</h2></th>
		</tr>
			<tr align="center">
...
<?php
			...
			?>
				<tr align="center">
					...
					<form action="#" method="post">		
					 <td>
						<button class="button" onclick="myfunction()"><a href="delete_employee.php?id=<?php echo $rows['e_id']; ?>">DELETE</a></button>&nbsp&nbsp
			...
			?>
					...
					<table >
<tr><td bgcolor=blue><a href='employee.php'><font color=red size=4><b>Add</a>
</table>
