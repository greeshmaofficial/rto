...
{
    $ques=$_POST['addque'];	
	$sql="insert into questions(question)values('$ques')";
	$result=mysqli_query($sql,$con);
}
?>	
</table>
<form  name="frm" action="addqt.php" method="post" >
<table border=0>

	    <tr><td>qust<td><textarea name="addque" cols="60" rows="2" id="addque" ></textarea>
		<tr><td>op1<td><textarea name="op1" cols="60" rows="2"></textarea>
		<tr><td>op2<td><textarea name="op2" cols="60" rows="2"></textarea>
		<tr><td>op3<td><textarea name="op3" cols="60" rows="2"></textarea>
		<tr><td colspan=2>
		1&nbsp&nbsp<input type=radio name=ans value=1>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
		2&nbsp&nbsp<input type=radio name=ans value=2>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
		3&nbsp&nbsp<input type=radio name=ans value=3>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<br><br>
