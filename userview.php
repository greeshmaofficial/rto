...
<table  align="center" border="2px" style="width:100%; line-height:30px;"  >
			...
			<tr >
				<td colspan="10" class="code"><h2 align="center">User Details</h2></th>
		</tr>
			<tr align="center">
...
<?php
			...
			?>
				<tr align="center">
					...
					<td><?php echo $rows['uphone']; ?> </td>
					
		
					<form action="#" method="post">		
					 <td>
						<button class="button" onclick="myfunction()"><a href="delete_user.php?id=<?php echo $rows['uid']; ?>">DELETE</a></button>&nbsp&nbsp
